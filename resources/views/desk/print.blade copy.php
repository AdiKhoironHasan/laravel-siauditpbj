    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="4" style="height: 100px;">
                ...
                >{{ $desk->tanggapan_auditee }}</textarea>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="height: 100px;">
                ...
                >{{ $desk->rencana_perbaikan }}</textarea>
            </td>
        </tr>
    </table>
