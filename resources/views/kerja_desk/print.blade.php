...
{{-- <div class="card card-orange">
    ...
    <div class="card-body"> --}}
        {{-- <form action="/rencana/timeline/kerjadesk/{{ $kerja_desk->id }}" method="POST">
            ...
            {{--
            <input readonly type="checkbox" disabled name="A" id="A" value="1">A
            <br>
            <input readonly type="checkbox" disabled name="B" id="B" class="B" value="1" disabled>B
            <br>
            <input readonly type="checkbox" disabled name="C" id="C" class="C" value="1" disabled>C --}}
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="number" id="tahun" name="tahun"
                            value="{{ $kerja_desk->tahun }}" required>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="integer" id="nilai_kontrak" name="nilai_kontrak"
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="nama_penyedia" name="nama_penyedia"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="nilai_hps" name="nilai_hps"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="nilai_penawaran" name="nilai_penawaran"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="metode_penilaian" name="metode_penilaian"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="metode_pemilihan" name="metode_pemilihan"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="metode_penyampaian" name="metode_penyampaian"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="metode_evaluasi" name="metode_evaluasi"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="jaminan_pelaksanaan"
                            name="jaminan_pelaksanaan" value="{{ $kerja_desk->jaminan_pelaksanaan }}">
                    </td>
                </tr>
            </table>
            <table class="table table-borderless">
                <tr>
                    ...
                    <td class="align-bottom d-flex justify-content-end">
                        <input readonly type="text" id="masa_kontrak_1" name="masa_kontrak_1" placeholder=""
                    ...
                    <td class="align-bottom d-flex justify-content-start">
                        <input readonly type="text" id="masa_kontrak_2" name="masa_kontrak_2" placeholder=""
                ...
                <tr>
                    ...
                    <td class="align-bottom d-flex justify-content-end">
                        <input readonly type="text" id="masa_jaminan_1" name="masa_jaminan_1" placeholder=""
                            value="{{ $kerja_desk->masa_jaminan_1 }}" onfocus="(this.type='date')">
                    </td>
                    <td>SD</td>

                    <td class="align-bottom d-flex justify-content-start">
                        <input readonly type="text" id="masa_jaminan_2" name="masa_jaminan_2" placeholder=""
            ...
            <table class="table table-borderless">
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="tanggal_sp2d" name="tanggal_sp2d"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="no_adendum" name="no_adendum"
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td>
                        <input readonly style="width: 80%" type="text" id="tanggal_sppbj" name="tanggal_sppbj"
            ...
            <table class="table table-borderless">
                {{-- <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="substansi_kontrak_1" id="substansi_kontrak_1"
                            value="1" {{ $kerja_desk->substansi_kontrak_1 != 0 ? 'checked':'' }}>
                    </td>
                    <td style="text-align: left">BAHASA DAN REDAKSIONAL</td>
                </tr> --}}
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="substansi_kontrak_2" id="substansi_kontrak_2"
                            value="1" {{ $kerja_desk->substansi_kontrak_2 != 0 ? 'checked':'' }}>
                    </td>
                    <td style="text-align: left">ANGKA DAN HURUF SESUAI</td>
                </tr>
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="substansi_kontrak_3" id="substansi_kontrak_3"
                            value="1" {{ $kerja_desk->substansi_kontrak_3 != 0 ? 'checked':'' }}>
                    </td>
                    <td style="text-align: left">TERDAPAT PARAF PADA SETIAP LEMBAR DOKUMEN KONTRAK</td>
                </tr>
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="substansi_kontrak_4" id="substansi_kontrak_4"
                            value="1" {{ $kerja_desk->substansi_kontrak_4 != 0 ? 'checked':'' }}>
                    </td>
            ...
            <table class="table table-borderless">
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="substansi_kontrak_5" id="substansi_kontrak_5"
                            value="1" {{ $substansi_kontrak_5 ? 'checked' :'' }}>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="substansi_kontrak_5_1" id="substansi_kontrak_5_1"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_5_1" id="substansi_kontrak_5_1"
                            value="1" disabled>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6" id="substansi_kontrak_6"
                            value="1" {{ $substansi_kontrak_6 ? 'checked' :'' }}>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1" id="substansi_kontrak_6_1"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1" id="substansi_kontrak_6_1"
                            value="1" disabled>
            ...
            <table class="table table-borderless">
                <tr>
                    ...
                    <td>
                        ...
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_1"
                            id="substansi_kontrak_6_1_1" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_1"
                            id="substansi_kontrak_6_1_1" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_1"
                            id="substansi_kontrak_6_1_1" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($substansi_kontrak_6_1)
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_2"
                            id="substansi_kontrak_6_1_2" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_2"
                            id="substansi_kontrak_6_1_2" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_2"
                            id="substansi_kontrak_6_1_2" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($substansi_kontrak_6_1)
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_3"
                            id="substansi_kontrak_6_1_3" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_3"
                            id="substansi_kontrak_6_1_3" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_3"
                            id="substansi_kontrak_6_1_3" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($substansi_kontrak_6_1)
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_4"
                            id="substansi_kontrak_6_1_4" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_4"
                            id="substansi_kontrak_6_1_4" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_4"
                            id="substansi_kontrak_6_1_4" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($substansi_kontrak_6_1)
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_5"
                            id="substansi_kontrak_6_1_5" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_5"
                            id="substansi_kontrak_6_1_5" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_5"
                            id="substansi_kontrak_6_1_5" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($substansi_kontrak_6_1)
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_6"
                            id="substansi_kontrak_6_1_6" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_6"
                            id="substansi_kontrak_6_1_6" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_6"
                            id="substansi_kontrak_6_1_6" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($substansi_kontrak_6_1)
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_7"
                            id="substansi_kontrak_6_1_7" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_7"
                            id="substansi_kontrak_6_1_7" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="substansi_kontrak_6_1_7"
                            id="substansi_kontrak_6_1_7" value="1" checked>
                        @endif
                    </td>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td>
                        <input readonly style="width: 80%" type="text" id="tanggal_surat" name="tanggal_surat"
                ...
                <tr>
                    ...
                    <td>
                        <input readonly style="width: 80%" type="text" id="durasi_penerimaan" name="durasi_penerimaan"
                ...
                <tr>
                    ...
                    <td>
                        <input readonly style="width: 80%" type="text" id="tanggal_disetujui" name="tanggal_disetujui"
            ...
            <table class="table table-borderless">
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="surat_pesanan_1" id="surat_pesanan_1" value="1"
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="surat_pesanan_2" id="surat_pesanan_2" value="1"
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_1"
                            id="penyusunan_program_mutu_1" value="1" {{ $kerja_desk->penyusunan_program_mutu_1 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_2"
                            id="penyusunan_program_mutu_2" value="1" {{ $kerja_desk->penyusunan_program_mutu_2 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_3"
                            id="penyusunan_program_mutu_3" value="1" {{ $kerja_desk->penyusunan_program_mutu_3 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_4"
                            id="penyusunan_program_mutu_4" value="1" {{ $kerja_desk->penyusunan_program_mutu_4 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_5"
                            id="penyusunan_program_mutu_5" value="1" {{ $kerja_desk->penyusunan_program_mutu_5 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_6"
                            id="penyusunan_program_mutu_6" value="1" {{ $kerja_desk->penyusunan_program_mutu_6 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyusunan_program_mutu_7"
                            id="penyusunan_program_mutu_7" value="1" {{ $kerja_desk->penyusunan_program_mutu_7 != 0 ?
                        'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pemeriksaan_bersama_1" id="pemeriksaan_bersama_1"
                            value="1" {{ $kerja_desk->pemeriksaan_bersama_1 != 0 ? 'checked':'' }}>
                    </td>
            ...
            <table class="table table-borderless">
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pemeriksaan_bersama_2" id="pemeriksaan_bersama_2"
                            value="1" {{ $pemeriksaan_bersama_2 ? 'checked' :'' }}>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="uang_muka" name="uang_muka"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="jaminan_uang_muka" name="jaminan_uang_muka"
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input readonly style="width: 80%" type="text" id="nama_bank_penerbit" name="nama_bank_penerbit"
            ...
            <table class="table table-borderless">
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pembayaran_uang_muka_1"
                            id="pembayaran_uang_muka_1" value="1" {{ $kerja_desk->pembayaran_uang_muka_1 != 0 ?
                        'checked':'' }}>
                    </td>
                    <td style="text-align: left">
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pembayaran_uang_muka_2"
                            id="pembayaran_uang_muka_2" value="1" {{ $kerja_desk->pembayaran_uang_muka_2 != 0 ?
                        'checked':'' }}>
                    </td>
                    <td style="text-align: left">
            ...
            <table class="table table-borderless">
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1" id="perubahan_kegiatan_1"
                            value="1" {{ $perubahan_kegiatan_1 ? 'checked' :'' }}>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($perubahan_kegiatan_1)
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1_3"
                            id="perubahan_kegiatan_1_3" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1_3"
                            id="perubahan_kegiatan_1_3" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1_3"
                            id="perubahan_kegiatan_1_3" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($perubahan_kegiatan_1)
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1_4"
                            id="perubahan_kegiatan_1_4" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1_4"
                            id="perubahan_kegiatan_1_4" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="perubahan_kegiatan_1_4"
                            id="perubahan_kegiatan_1_4" value="1" checked>
                        @endif
                    </td>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="asuransi_2" id="asuransi_2" value="1" {{
                            $kerja_desk->asuransi_2 !=
                        0 ? 'checked':'' }}>
                    </td>
                    <td style="text-align: left">
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="uji_coba_barang_1" id="uji_coba_barang_1"
                            value="1" {{ $uji_coba_barang_1 ? 'checked' :'' }}>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="uji_coba_barang_1_1" id="uji_coba_barang_1_1"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="uji_coba_barang_1_1" id="uji_coba_barang_1_1"
                            value="1" disabled>
                ...
                <tr>
                    ...
                    <td style="width: 10%">
                        ...
                        @if ($uji_coba_barang_1)
                        <input readonly type="checkbox" disabled name="uji_coba_barang_1_2" id="uji_coba_barang_1_2"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="uji_coba_barang_1_2" id="uji_coba_barang_1_2"
                            value="1" disabled>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="uji_coba_barang_2" id="uji_coba_barang_2"
                            value="1" {{ $uji_coba_barang_2 ? 'checked' :'' }}>
                    </td>
                    <td style="width: 40%; text-align:left">MEMERLUKAN KEAHLIAN KHUSUS</td>
                    <td style="width: 10%">
                        @if ($kerja_desk->uji_coba_barang_2_1 == 0)
                        @if ($uji_coba_barang_2)
                        <input readonly type="checkbox" disabled name="uji_coba_barang_2_1" id="uji_coba_barang_2_1"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="uji_coba_barang_2_1" id="uji_coba_barang_2_1"
                            value="1" disabled>
                ...
                <tr>
                    ...
                    <td style="width: 10%">
                        ...
                        @if ($uji_coba_barang_2)
                        <input readonly type="checkbox" disabled name="uji_coba_barang_2_2" id="uji_coba_barang_2_2"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="uji_coba_barang_2_2" id="uji_coba_barang_2_2"
                            value="1" disabled>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="uji_coba_barang_3" id="uji_coba_barang_3"
                            value="1" {{ $uji_coba_barang_3 ? 'checked' :'' }}>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="uji_coba_barang_3_1" id="uji_coba_barang_3_1"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="uji_coba_barang_3_1" id="uji_coba_barang_3_1"
                            value="1" disabled>
                ...
                <tr>
                    ...
                    <td style="width: 10%">
                        ...
                        @if ($uji_coba_barang_3)
                        <input readonly type="checkbox" disabled name="uji_coba_barang_3_2" id="uji_coba_barang_3_2"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="uji_coba_barang_3_2" id="uji_coba_barang_3_2"
                            value="1" disabled>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="serah_terima_barang_1" id="serah_terima_barang_1"
                            value="1" {{ $serah_terima_barang_1 ? 'checked' :'' }}>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="serah_terima_barang_1_1"
                            id="serah_terima_barang_1_1" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="serah_terima_barang_1_1"
                            id="serah_terima_barang_1_1" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="serah_terima_barang_1_1"
                            id="serah_terima_barang_1_1" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="serah_terima_barang_2" id="serah_terima_barang_2"
                            value="1" {{ $serah_terima_barang_2 ? 'checked' :'' }}>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="serah_terima_barang_2_1"
                            id="serah_terima_barang_2_1" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="serah_terima_barang_2_1"
                            id="serah_terima_barang_2_1" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="serah_terima_barang_2_1"
                            id="serah_terima_barang_2_1" value="1" checked>
                        @endif
                    </td>
                    <td style="width: 40%; text-align:left">
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="serah_terima_barang_3" id="serah_terima_barang_3"
                            value="1" {{ $kerja_desk->serah_terima_barang_3 != 0 ? 'checked':'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pembayaran_1" id="pembayaran_1" value="1" {{
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pembayaran_2" id="pembayaran_2" value="1" {{
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="pembayaran_3" id="pembayaran_3" value="1" {{
                            $pembayaran_3 ? 'checked' :'' }}>
                    </td>
                    <td style="width: 40%; text-align:left">PEMBAYARAN MENGGUNAKAN L/C</td>
                    <td style="width: 10%">
                        @if ($kerja_desk->pembayaran_3_1 == 0)
                        @if ($pembayaran_3)
                        <input readonly type="checkbox" disabled name="pembayaran_3_1" id="pembayaran_3_1" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="pembayaran_3_1" id="pembayaran_3_1" value="1"
                            disabled>
                        @endif
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="denda_1" id="denda_1" value="1" {{ $denda_1
                            ? 'checked' :'' }}>
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="penyesuaian_harga_1" id="penyesuaian_harga_1"
                            value="1" {{ $penyesuaian_harga_1 ? 'checked' :'' }}>
                    </td>
                    <td style="width: 40%; text-align:left">ADA PENYESUAIAN HARGA</td>
                    <td style="width: 10%">
                        @if ($kerja_desk->penyesuaian_harga_1_1 == 0)
                        @if ($penyesuaian_harga_1)
                        <input readonly type="checkbox" disabled name="penyesuaian_harga_1_1" id="penyesuaian_harga_1_1"
                            value="1">
                        @else
                        <input readonly type="checkbox" disabled name="penyesuaian_harga_1_1" id="penyesuaian_harga_1_1"
                            value="1" disabled>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="perpanjangan_waktu_1" id="perpanjangan_waktu_1"
                            value="1" {{ $perpanjangan_waktu_1 ? 'checked' :'' }}>
                    </td>
                    </td>
                    ...
                    <td style="width: 10%">
                        ...
                        <input readonly type="checkbox" disabled name="perpanjangan_waktu_1_1"
                            id="perpanjangan_waktu_1_1" value="1">
                        @else
                        <input readonly type="checkbox" disabled name="perpanjangan_waktu_1_1"
                            id="perpanjangan_waktu_1_1" value="1" disabled>
                        @endif
                        @else
                        <input readonly type="checkbox" disabled name="perpanjangan_waktu_1_1"
                            id="perpanjangan_waktu_1_1" value="1" checked>
                        @endif
                    </td>
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="laporan_hasil_1" id="laporan_hasil_1" value="1"
                ...
                <tr>
                    <td style="width: 10%">
                        <input readonly type="checkbox" disabled name="laporan_hasil_2" id="laporan_hasil_2" value="1"
