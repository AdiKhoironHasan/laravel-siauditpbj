        ...
        <form action="/kerjadesk/hasil" method="POST">
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input type="text" id="no_kontrak" name="no_kontrak" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">NILAI KONTRAK</td>
                    <td class="align-bottom">
                        <input type="text" id="nilai_kontrak" name="nilai_kontrak" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">TANGGAL KONTRAK</td>
                    <td class="align-bottom">
                        <input type="text" id="tanggal_kontrak" name="tanggal_kontrak" onfocus="(this.type='date')"
                            required>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input type="text" id="nilai_hps" name="nilai_hps" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">NILAI PENAWARAN</td>
                    <td class="align-bottom">
                        <input type="text" id="nilai_penawaran" name="nilai_penawaran" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">METODE PENILAIAN KUALIFIKASI</td>
                    <td class="align-bottom">
                        <input type="text" id="metode_penilaian" name="metode_penilaian" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">METODE PEMILIHAN PENGADAAN BARANG</td>
                    <td class="align-bottom">
                        <input type="text" id="metode_pemilihan" name="metode_pemilihan" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">METODE PENYAMPAIAN DOKUMEN</td>
                    <td class="align-bottom">
                        <input type="text" id="metode_penyampaian" name="metode_penyampaian" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">METODE EVALUASI PENAWARAN</td>
                    <td class="align-bottom">
                        <input type="text" id="metode_evaluasi" name="metode_evaluasi" required>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;text-align:left">JAMINAN PELAKSANAAN</td>
                    <td class="align-bottom">
                        <input type="text" id="jaminan_pelaksanaan" name="jaminan_pelaksanaan" required>
                    </td>
                </tr>
            </table>
            <table class="table table-borderless">
            ...
            <table class="table table-borderless">
                <tr>
                    ...
                    <td class="align-bottom">
                        <input type="text" id="tanggal_sp2d" name="tanggal_sp2d" placeholder=""
                            onfocus="(this.type='date')" required>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="align-bottom">
                        <input type="text" id="no_adendum" name="no_adendum" required>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="tanggal_sppbj" name="tanggal_sppbj" onfocus="(this.type='date')"
                            required>
                    </td>
                </tr>
                <tr>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="tanggal_surat" name="tanggal_surat" onfocus="(this.type='date')"
                            required>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="tanggal_disetujui" name="tanggal_disetujui" onfocus="(this.type='date')"
                            required>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input type="text" id="uang_muka" name="uang_muka" required>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="align-bottom">
                        <input type="text" id="nama_bank_penerbit" name="nama_bank_penerbit" required>
                    </td>
                </tr>
                {{-- <tr>
